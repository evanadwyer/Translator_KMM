package com.evanadwyer.translator_kmm.presentation
...
import com.evanadwyer.translator_kmm.android.MainActivity
import com.evanadwyer.translator_kmm.android.R
import com.evanadwyer.translator_kmm.android.di.AppModule
import com.evanadwyer.translator_kmm.android.voice_to_text.di.VoiceToTextModule
import com.evanadwyer.translator_kmm.translate.data.remote.FakeTranslateClient
import com.evanadwyer.translator_kmm.translate.domain.translate.TranslateClient
import com.evanadwyer.translator_kmm.voice_to_text.data.FakeVoiceToTextParser
...
class VoiceToTextE2E {
    ...
    fun recordAndTranslate() = runBlocking<Unit> {
        ...
        composeRule.onNodeWithText(context.getString(R.string.translate), ignoreCase = true).performClick()
        composeRule.onNodeWithText(parser.voiceResult).assertIsDisplayed()
